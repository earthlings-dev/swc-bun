...
use swc_common::{FileName, SourceMap, comments::SingleThreadedComments, input::StringInput};
use swc_es_parser::{EsSyntax, Parser, Syntax, TsSyntax, lexer::Lexer, parse_file_as_program};
