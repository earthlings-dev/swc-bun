...
#[cfg(all(
    not(feature = "sys"),
    not(all(feature = "js", target_arch = "wasm32")),
...
#[cfg(any(
    all(all(feature = "js", target_arch = "wasm32"), feature = "sys"),
    all(all(feature = "js", target_arch = "wasm32"), feature = "sys-minimal")
))]
compile_error!(
...
#[cfg(all(all(feature = "js", target_arch = "wasm32"), not(target_arch = "wasm32")))]
compile_error!(
