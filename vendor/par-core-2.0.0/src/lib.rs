...
// When both backends are enabled (e.g. workspace --all-features), prefer
// chili to keep builds deterministic and avoid conflicting moves.
    ...
    RB: Send,
{
    ...
    #[cfg(all(feature = "rayon", not(feature = "chili")))]
