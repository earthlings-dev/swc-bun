...
//!
//! 4. `js`
#![cfg_attr(all(feature = "js", target_arch = "wasm32"), doc = "(enabled),")]
#![cfg_attr(not(all(feature = "js", target_arch = "wasm32")), doc = "(disabled),")]
...
#[cfg(any(
    all(
        feature = "sys-default",
        any(
            all(feature = "js-default", target_arch = "wasm32"),
            feature = "jsc-default",
